...
def test_demo_editor_selected_command_presentation(tmp_path: Path) -> None:
    ...
    assert '["annotation", "cursor", "measurement", "reference-display", "save-export", "wgen", "demo", "trigger"].includes(editorKind)' in app_source
    assert '["annotation", "cursor", "measurement", "reference", "reference-display", "save-export", "wgen", "demo", "trigger"].includes(editorKind)' in app_source
