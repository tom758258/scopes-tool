...
| --- | --- | --- | --- |
| Core | `scopes-tool` | `scopes_tool_core` | `docs/core/README.md`, `docs/core/integration.md`, `docs/core/sequence.md`, `docs/core/sequence.zh-TW.md`, `docs/core/supported-models.md` |
