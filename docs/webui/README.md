...
pair-measurement choices. Periodic Capture (`capture-batch`) uses the dedicated
Workflow editor. `measure-until` and `triggered-capture-series` remain
metadata-driven Generic Forms. Trigger,
