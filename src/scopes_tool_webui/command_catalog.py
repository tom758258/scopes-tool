...
COMMANDS = (
    ...
    },
    {
        ...
        "modes": ("live", "simulate"),
        "fields": (
            {"name": "slot", "type": "integer", "minimum": 1, "maximum": 2, "options": (1, 2), "required": True, "label_key": "reference.slot", "option_label": "reference-waveform", "help_key": "reference.slot"},
    ...
    },
    {
        ...
        "fields": (
            {"name": "action", "type": "enum", "options": ("query", "set"), "default": "query"},
            {"name": "slot", "type": "integer", "minimum": 1, "maximum": 2, "options": (1, 2), "default": 1, "label_key": "reference.slot", "option_label": "reference-waveform", "help_key": "reference.slot"},
    ...
    },
    {
        ...
        "category": "System",
        "label": "Instrument Status Summary",
        "modes": ("live", "simulate"),
        "fields": (),
    },
    {
    ...
    },
    {
        "id": "system-opc",
        "category": "System",
        "label": "Wait for Operation Complete",
        "modes": ("live", "simulate"),
        "fields": (),
    },
    {
...
TRIGGER_SEARCH_SERIAL_SEGMENTED_WORKFLOW_COMMANDS = (
    ...
    _action_command("external-trigger-range", "Trigger", "External trigger range", (_command_field("range_volts", "number", exclusive_minimum=0, visible_if=_set_action_visibility(), required_if=_set_action_visibility()),), group="external", editor="trigger"),
    ...
    _action_command("external-trigger-probe", "Trigger", "External trigger probe", (_command_field("attenuation", "number", exclusive_minimum=0, visible_if=_set_action_visibility(), required_if=_set_action_visibility()),), group="external", editor="trigger"),
    ...
    _action_command(
        "trigger-pulse-width", "Trigger", "Glitch / pulse-width trigger", (
            ...
            _command_field("time_seconds", "number", exclusive_minimum=0, visible_if=_set_action_visibility({"field": "qualifier", "in": ("greater-than", "less-than")}), required_if=_set_action_visibility({"field": "qualifier", "in": ("greater-than", "less-than")})),
            _command_field("min_time_seconds", "number", exclusive_minimum=0, visible_if=_set_action_visibility({"field": "qualifier", "equals": "range"}), required_if=_set_action_visibility({"field": "qualifier", "equals": "range"})),
            _command_field("max_time_seconds", "number", exclusive_minimum=0, visible_if=_set_action_visibility({"field": "qualifier", "equals": "range"}), required_if=_set_action_visibility({"field": "qualifier", "equals": "range"})),
    ...
    _action_command(
        "trigger-transition", "Trigger", "Transition trigger", (
            ...
            _command_field("low_level", "number", visible_if=_set_action_visibility(), required_if=_set_action_visibility()),
            _command_field("high_level", "number", visible_if=_set_action_visibility(), required_if=_set_action_visibility()),
            _command_field("time_seconds", "number", exclusive_minimum=0, visible_if=_set_action_visibility(), required_if=_set_action_visibility()),
        ),
        group="transition",
        editor="trigger",
    ),
    _action_command(
        "trigger-delay", "Trigger", "Delay trigger", (
            ...
            _command_field("time_seconds", "number", minimum=4e-9, maximum=10, visible_if=_set_action_visibility(), required_if=_set_action_visibility()),
    ...
    _action_command(
        "trigger-setup-hold", "Trigger", "Setup and hold trigger", (
            ...
            _command_field("slope", "enum", options=_BINARY_SLOPES, visible_if=_set_action_visibility(), required_if=_set_action_visibility()),
            _command_field("setup_time_seconds", "number", exclusive_minimum=0, visible_if=_set_action_visibility(), required_if=_set_action_visibility()),
            _command_field("hold_time_seconds", "number", exclusive_minimum=0, visible_if=_set_action_visibility(), required_if=_set_action_visibility()),
        ),
        group="setup-hold",
        editor="trigger",
    ),
    _action_command(
        "trigger-edge-burst", "Trigger", "Nth edge burst trigger", (
            ...
            _command_field("slope", "enum", options=_BINARY_SLOPES, visible_if=_set_action_visibility(), required_if=_set_action_visibility()),
            _command_field("count", "integer", minimum=1, visible_if=_set_action_visibility(), required_if=_set_action_visibility()),
            _command_field("idle_time", "number", minimum=1e-8, maximum=10, visible_if=_set_action_visibility(), required_if=_set_action_visibility()),
            _command_field("level", "number", visible_if=_set_action_visibility()),
        ),
        group="edge-burst",
        editor="trigger",
    ...
    _action_command(
        "serial-uart", "Serial", "UART configuration", (
            ...
            _command_field("baud_rate", "integer", minimum=100, maximum=12_000_000, spinner=False, visible_if=_set_action_visibility()), _command_field("data_bits", "integer", minimum=5, maximum=9, visible_if=_set_action_visibility()),
