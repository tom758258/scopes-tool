...
TRIGGER_SEARCH_SERIAL_SEGMENTED_WORKFLOW_COMMANDS = (
    ...
    },
    {
        ...
        "group": "measurement",
        "editor": "workflow",
        "fields": (_command_field("channels", "multi-enum", options=(1, 2, 3, 4), serialize="csv", help_key="workflow.measurement.channels"), _command_field("items", "multi-enum", options=_DIRECT_MEASUREMENT_ITEMS, serialize="csv", default=("vpp", "frequency"), help_key="workflow.measurement.items"), _command_field("pairs", "string", help_key="workflow.measurement.pairs"), _command_field("pair_items", "string", options=PAIR_MEASUREMENT_ITEMS, default="phase,delay", help_key="workflow.measurement.pair_items"), _command_field("interval_seconds", "number", minimum=0, default=1, help_key="workflow.measurement.interval_seconds"), _command_field("count", "integer", minimum=1, help_key="workflow.measure-log.count"), _command_field("duration_seconds", "number", minimum=0, help_key="workflow.measure-log.duration_seconds"), _command_field("save_results", "boolean", default=True, help_key="workflow.save_results"), _command_field("stop_on_error", "boolean", default=False, help_key="workflow.measure-log.stop_on_error")),
    },
    {
