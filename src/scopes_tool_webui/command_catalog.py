...
TRIGGER_SEARCH_SERIAL_SEGMENTED_WORKFLOW_COMMANDS = (
    ...
    _action_command("external-trigger-range", "Trigger", "External trigger range", (_command_field("range_volts", "number", exclusive_minimum=0, visible_if=_set_action_visibility(), required_if=_set_action_visibility(), help_key="external-trigger-range.range_volts"),), group="external", editor="trigger"),
    _action_command("trigger-edge-external-level", "Trigger", "External trigger level", (_command_field("level", "number", visible_if=_set_action_visibility(), required_if=_set_action_visibility(), help_key="trigger-edge-external-level.level"),), group="external", editor="trigger"),
